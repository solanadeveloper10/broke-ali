  ...
  return <>
    ...
    <div className='wrapper'>
      <header className={'header loaded'}>
        ...
        <a href="https://www.dextools.io/app/en/solana/pair-explorer/6FGhojmeSbEKXHjz7mGWixsq5dcCxJDF95CzBPMd2SjN?t=1739473719602" target='_blank' className='social-link'>
